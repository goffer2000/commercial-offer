...
def form():
    if request.method == "POST":
        ...
        # Общая сумма
        total = mat_cost + aquawax_cost + base_cost + work_sum + extra_cost + primer_cost
